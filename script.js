/* =========================================================
   ...
   Three.js loads BEFORE any THREE code runs
   ========================================================= */
...
loadThreeJS(function () {
    ...
    function createBlock(
        ...
        if (
            ...
            finalType =
                placedBlocks.get(key);
        }


        const material =
            blockMaterials[finalType] ||
            blockMaterials.dirt;
                        ...
                        if (
                            ...
                            const key =
                                getBlockKey(
                                    ...
                                    object.userData.blockX,

                                    object.userData.blockY,

                                    object.userData.blockZ
                                );
    ...
    */
    ...
    async function startPlaying() {
        ...
        /*
           IMPORTANT:
           Request fullscreen/orientation
           directly from PLAY click.
        */
    ...
    /*
       Small loading delay.
       Three.js is ALREADY loaded here.
    */
    ...
    console.log(
        "Mind Craft final script loaded successfully."
    );
